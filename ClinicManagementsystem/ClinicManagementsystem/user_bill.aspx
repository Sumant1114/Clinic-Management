<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="user_bill.aspx.cs" Inherits="ClinicManagementsystem.user_bill" %>
              ...
              <div class="row">
               ...
               <div class="row">
                 <div class="col-12">
                    ...
                    <div class="form-group">
                       <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Bill Amount " TextMode="MultiLine" Rows="2" ReadOnly="True"></asp:TextBox>
                    </div>
                 </div>
              </div>
           </div>
