<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpatientmanagment.aspx.cs" Inherits="ClinicManagementsystem.adminmembermanagment" %>
    ...
    <div class="container-fluid" style="    background: #f2f5f7;" >
      <div class="row">
         ...
         <div class="col-md-7">
            ...
            <div class="card">
               <div class="card-body">
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:clinicdbconnectionString %>" SelectCommand="SELECT * FROM [user_signup_tbl]"></asp:SqlDataSource>
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Patient List</h4>
